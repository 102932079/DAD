...
GO
PRINT N'Dropping unnamed constraint on [dbo].[ENROLMENT]...';


GO
ALTER TABLE [dbo].[ENROLMENT] DROP CONSTRAINT [FK__ENROLMENT__Stude__5C37ACAD];
...
GO
ALTER TABLE [dbo].[STUDENT] DROP CONSTRAINT [CK__STUDENT__Gender__4A18FC72];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[STUDENT])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Student] ([StudentID], [Surname])
        SELECT   [StudentID],
                 [Surname]
        FROM     [dbo].[STUDENT]
